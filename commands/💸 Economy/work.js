    ...
    try {
      ...
      if(data.work !== 0 && timeout - (Date.now() - data.work) > 0){
        ...
        return message.reply({embed: new MessageEmbed()
          ...
          .setTitle(`<a:no:921989165242003476> You've already worked recently!`)
      ...
      //YEA
        ...
        return message.reply(new MessageEmbed()
          ...
          .setFooter(user.tag, user.displayAvatarURL({dynamic: true}))
          .setTitle(`<a:yes2:921988805442043925> You worked as a **${replies[result]}** and earned \`${nFormatter(amount)} 💸\``)
