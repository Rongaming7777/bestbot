    ...
    try {
      ...
      if(data.hourly !== 0 && timeout - (Date.now() - data.hourly) > 0){
        ...
        return message.reply({embed: new MessageEmbed()
          ...
          .setTitle(`<a:no:921989165242003476> You've already collected your hourly reward!`)
      ...
      //YEA
        ...
        return message.reply(new MessageEmbed()
          ...
          .setFooter(message.author.tag, message.author.displayAvatarURL({dynamic: true}))
          .setTitle(`<a:yes2:921988805442043925> You've collected your hourly reward of \`${amount} 💸\``)
