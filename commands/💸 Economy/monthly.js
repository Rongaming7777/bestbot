    ...
    try {
      ...
      if(data.monthly !== 0 && timeout - (Date.now() - data.monthly) > 0){
        ...
        return message.reply({embed: new MessageEmbed()
          ...
          .setTitle(`<a:no:921989165242003476> You've already collected your monthly reward!`)
      ...
      //YEA
        ...
        return message.reply(new MessageEmbed()
          ...
          .setFooter(message.author.tag, message.author.displayAvatarURL({dynamic: true}))
          .setTitle(`<a:yes2:921988805442043925> You've collected your monthly reward of \`${amount} 💸\``)
