    ...
    try{
      ...
      if (player.playing)
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<a:no:921989165242003476> The song is already resumed!`)
      ...
      return message.channel.send(new MessageEmbed()
        .setTitle(`<a:yes2:921988805442043925> ${player.playing ? `${emoji.msg.resume} Resumed` : `${emoji.msg.pause} Paused`} the Player.`)
