    ...
    try {
      ...
      if (!args[0])
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<a:no:921989165242003476> You may forward for \`1\` - \`${player.queue.current.duration}\``)
        );
      ...
      return message.channel.send(new MessageEmbed()
        .setTitle(`<a:yes2:921988805442043925> ${emoji.msg.forward} Forwarded the Song `)
