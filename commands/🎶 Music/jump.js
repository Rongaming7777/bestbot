    ...
    try {
      ...
      if (!args[0])
        return message.channel.send(new MessageEmbed()
          .setFooter(es.footertext, es.footericon)
          .setColor(es.wrongcolor)
          .setTitle(`<a:no:921989165242003476> Please include to which track you want to jump`)
      ...
      if (isNaN(args[0]))
        return message.channel.send(new MessageEmbed()
          .setFooter(es.footertext, es.footericon)
          .setColor(es.wrongcolor)
          .setTitle(`<a:no:921989165242003476> It has to be a queue **Number**`)
        );
      ...
      if (Number(args[0]) > player.queue.size)
        return message.channel.send(new MessageEmbed()
          .setFooter(es.footertext, es.footericon)
          .setColor(es.wrongcolor)
          .setTitle(`<a:no:921989165242003476> That song is not in the queue, sorry!`)
        );
      ...
      return message.channel.send(new MessageEmbed()
        .setTitle(`<a:yes2:921988805442043925> Jumped to the: \`${args[0]}\` Song`)
