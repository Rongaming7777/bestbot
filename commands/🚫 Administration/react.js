     ...
     return message.channel.send(new MessageEmbed()
      ...
      if (!args[0])
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<a:no:921989165242003476> Please Include a MessageID`)
      ...
      if (args[0].length != 18)
          ...
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<a:no:921989165242003476> Please Include a Valid MessageID`)
        );
      ...
      if (!args[1]) 
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<a:no:921989165242003476> Please Include a Emoji`)
          .setDescription(`Usage: \`${prefix}react <msgid> <Emoji>\`\nExample: \`${prefix}react 442355791412854784 ${emoji.msg.SUCCESS}\``)
        );
      ...
      if(args[1].includes("<")){
        ...
        if (!emojii)
          return message.channel.send(new MessageEmbed()
            .setColor(es.wrongcolor)
            .setFooter(es.footertext, es.footericon)
            .setTitle(`<a:no:921989165242003476> Please Include a valid Emoji`)
            .setDescription(`Usage: \`${prefix}react <msgid> <Emoji>\`\nExample: \`${prefix}react 442355791412854784 ${emoji.msg.SUCCESS}\``)
          );
