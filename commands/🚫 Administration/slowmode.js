  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      return message.channel.send(new Discord.MessageEmbed()
        ...
        .setTitle("<a:no:921989165242003476> I am missing the permission to `MANAGE CHANNELS`!")
      )
      ...
      if (!isNaN(args[0]) || parseInt(args[0]) < 0) {
        ...
        message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<a:yes2:921988805442043925> Set Slowmode to: ${args[0]}!`)
        );
        ...
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<a:no:921989165242003476> Your Input is not a Number, please retry!`)
