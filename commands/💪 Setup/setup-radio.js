      ...
      try{
        ...
        if (isNaN(args[0])) {
            return message.channel.send(new MessageEmbed()
              ...
              .setTitle(`<a:no:921989165242003476> Not a valid radio station`)
        ...
        if (Number(args[1]) > 150 || Number(args[1]) < 1)
          return message.channel.send(new MessageEmbed()
            .setColor(es.wrongcolor)
            .setFooter(client.user.username, es.footericon)
            .setTitle(`<a:no:921989165242003476> Volume Number out of Range`)
        ...
        //if not found send an error
          ...
          return message.channel.send(new MessageEmbed()
            .setColor(es.wrongcolor)
            .setFooter(client.user.username, es.footericon)
            .setTitle(`<a:no:921989165242003476> Radio Station not found`)
