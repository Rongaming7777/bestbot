          ...
          .then(collected => {
            ...
            if (channel) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:yes2:921988805442043925> The Channel: \`${channel.name}\` is now registered as the Suggestion Channel`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          ...
          .then(collected => {
            ...
            if (message) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:yes2:921988805442043925> I changed the Approve Message to...`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          ...
          .then(collected => {
            ...
            if (message) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:yes2:921988805442043925> I changed the Deny Message to...`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setDescription(`${message.content}`.substr(0, 2048))
                  .setFooter(es.footertext, es.footericon)
                );
          ...
          .then(collected => {
            ...
            if (message) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:yes2:921988805442043925> I changed the Maybe Message to...`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setDescription(`${message.content}`.substr(0, 2048))
                  .setFooter(es.footertext, es.footericon)
                );
          ...
          .then(collected => {
            ...
            if (message) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:yes2:921988805442043925> I changed the Status Text to...`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setDescription(`${message.content}`.substr(0, 2048))
                  .setFooter(es.footertext, es.footericon)
                );
          ...
          .then(collected => {
            ...
            if (message) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:yes2:921988805442043925> I changed the Footer Text to...`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setDescription(`${message.content}`.substr(0, 2048))
                  .setFooter(es.footertext, es.footericon)
                );
            ...
            if (reaction) {
              try {
                if (collected.first().emoji.id && collected.first().emoji.id.length > 2) {
                  ...
                  return message.reply(new Discord.MessageEmbed()
                    .setTitle(`<a:yes2:921988805442043925> Successfully changed the Approve emoji`)
                    .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                    .setDescription(`\`\`\`${String(JSON.stringify(e)).substr(0, 2000)}\`\`\``)
                    .setFooter(es.footertext, es.footericon)
                  );
            ...
            if (reaction) {
              try {
                if (collected.first().emoji.id && collected.first().emoji.id.length > 2) {
                  ...
                  return message.reply(new Discord.MessageEmbed()
                    .setTitle(`<a:yes2:921988805442043925> Successfully changed the Deny emoji`)
                    .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                    .setDescription(`\`\`\`${String(JSON.stringify(e)).substr(0, 2000)}\`\`\``)
                    .setFooter(es.footertext, es.footericon)
                  );
