  ...
  module.exports = {
    ...
    run: async (client, message, args, cmduser, text, prefix) => {
      ...
      if (timeouterror)
        ...
        if(add == "second")
        return message.reply(new Discord.MessageEmbed()
          .setTitle("<a:no:921989165242003476> ERROR | SECOND TWITTER IS DISABLED")
          .setColor(es.wrongcolor)
          ...
          if (timeouterror)
            ...
            await T.get('users/search', {
              ...
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:yes2:921988805442043925> I will now watch for new Posts in this account: \`${TwitterName}\``)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
              ...
              .then(collected => {
                ...
                if (channel) {
                    try {
                        ...
                        //require("../../social_log/twitterfeed").creat_twit(client);
                        return message.reply(new Discord.MessageEmbed()
                          .setTitle(`<a:yes2:921988805442043925> I will now post Twitter Messages in \`${channel.name}\``)
                          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                          .setDescription(`\n\nYou need to have The TWITTERNAME, TWITTERID, and DISCORDCHANNEl and MESSAGE to be right, so that the autoposter works!`)
                          .addField("**NOTE THERE MIGHT BE AN UP TO 7 MINUTES DELAY!** (because of Rate limits)", "When posting a new Twit")
                          .setFooter(es.footertext, es.footericon)
            ...
            await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
              ...
              .then(collected => {
                try {
                  ...
                  //require("../../social_log/twitterfeed").creat_twit(client);
                  return message.reply(new Discord.MessageEmbed()
                    .setTitle(`<a:yes2:921988805442043925> I will now post The Twitter Messages with the Twitter Post: `)
            ...
            if (timeouterror)
              return message.reply(new Discord.MessageEmbed()
                ...
                .setFooter(es.footertext, es.footericon)
                  ...
                  //require("../../social_log/twitterfeed").creat_twit(client);
                  return message.reply(new Discord.MessageEmbed()
                    .setTitle(`<a:yes2:921988805442043925> ${client.social_log.get(message.guild.id, `${add}twitter.REETWET`) ? "Enabled Showing Retweets": "Disabled Showing Retweets"}`)
            ...
            .then(async collected => {
              try {
                ...
                message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:yes2:921988805442043925> Set the TWITTER USER ID TO: \`${collected.first().content}\``.substr(0, 256))
                ...
                await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
                  ...
                  .then(async collected => {
                    try {
                      ...
                      //require("../../social_log/twitterfeed").creat_twit(client);
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> Set the TWITTER USER Name TO: \`${collected.first().content}\``.substr(0, 256))
