      ...
      var adminroles = client.settings.get(message.guild.id, "adminroles")
        ...
        if (temptype == "channel") {
            ...
            .then(collected => {
              ...
              if (channel) {
                try {
                  ...
                  return message.reply(new Discord.MessageEmbed()
                    .setTitle(`<a:yes2:921988805442043925> I will now send all logs into: \`${channel.name}\``)
                    .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                    .setFooter(es.footertext, es.footericon)
                  );
                } catch (e) {
          ...
          try {
            ...
            return message.reply(new Discord.MessageEmbed()
              .setTitle(`<a:yes2:921988805442043925> Disabled Logger, I wont log anything anymore`)
              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
              .setFooter(es.footertext, es.footericon)
            );
          } catch (e) {
