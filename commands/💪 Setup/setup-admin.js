...
*React with the Right Emoji according to the Right action*`)
      ...
      await tempmsg.channel.awaitMessages(m=>m.author.id == message.author.id, {
        ...
        .then(async collected => {
          ...
          if(!cmd) 
            return message.reply({embed: new Discord.MessageEmbed()
              .setTitle("<a:no:921989165242003476> ERROR | Unable to find the Command")
              .setColor(es.wrongcolor)
              .setFooter(es.footertext, es.footericon)
            });
          if(!cmd.category.toLowerCase().includes("admin")) 
            return message.reply({embed: new Discord.MessageEmbed()
              .setTitle("<a:no:921989165242003476> ERROR | Command is **not** an Administration Command")
              .setColor(es.wrongcolor)
              .setFooter(es.footertext, es.footericon)
            });
          thecmd = cmd.name;
            ...
            .then(collected => {
              ...
              if (role) {
                ...
                if (adminroles.includes(role.id)) return message.reply({embed: new Discord.MessageEmbed()
                  .setTitle(`<a:no:921989165242003476> ERROR | The role: \`${role.name}\` is already registered as an Admin Role for ${thecmd}`)
                  .setColor(es.wrongcolor)
                  .setFooter(es.footertext, es.footericon)
                });
                try {
                  ...
                  return message.reply({embed: new Discord.MessageEmbed()
                    .setTitle(`<a:yes2:921988805442043925> The role: \`${role.name}\` is now registered as an Admin Role`)
                    .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                ...
                if (adminroles.includes(user.id)) return message.reply({embed: new Discord.MessageEmbed()
                  .setTitle(`<a:no:921989165242003476> ERROR | The User: \`${user.username}\` is already registered as an Admin Role for ${thecmd}`)
                  .setColor(es.wrongcolor)
                  .setFooter(es.footertext, es.footericon)
                });
                try {
                  ...
                  return message.reply({embed: new Discord.MessageEmbed()
                    .setTitle(`<a:yes2:921988805442043925> The User: \`${user.username}\` is now registered as an Admin Role`)
                    .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                    .setDescription(`Everyone with one of those Roles/Users:\n${cmdrole.join("\n")}\nis now able to use the ${thecmd} Admin Commands`.substr(0, 2048))
                    .setFooter(es.footertext, es.footericon)
                  });
          ...
          await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
            ...
            .then(collected => {
              ...
              if (role) {
                var adminroles = client.settings.get(message.guild.id, `cmdadminroles.${thecmd}`)
                if (!adminroles.includes(role.id)) return message.reply({embed: new Discord.MessageEmbed()
                  .setTitle(`<a:no:921989165242003476> ERROR | The role: \`${role.name}\` is not registered as an Admin Role yet for ${thecmd}`)
                  .setColor(es.wrongcolor)
                  .setFooter(es.footertext, es.footericon)
                });
                try {
                  ...
                  return message.reply({embed: new Discord.MessageEmbed()
                    .setTitle(`<a:yes2:921988805442043925> The role: \`${role.name}\` is not registered as an Admin Role anymore`)
                    .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                    .setDescription(`Everyone with one of those Roles/Users:\n${cmdrole.join("\n")}\nis now able to use the ${thecmd} Admin Commands`.substr(0, 2048))
                    .setFooter(es.footertext, es.footericon)
                  });
                ...
                var adminroles = client.settings.get(message.guild.id, `cmdadminroles.${thecmd}`)
                if (!adminroles.includes(user.id)) return message.reply({embed: new Discord.MessageEmbed()
                  .setTitle(`<a:no:921989165242003476> ERROR | The User: \`${user.username}\` is not registered as an Admin Role yet for ${thecmd}`)
                  .setColor(es.wrongcolor)
                  .setFooter(es.footertext, es.footericon)
                });
                try {
                  ...
                  return message.reply({embed: new Discord.MessageEmbed()
                    .setTitle(`<a:yes2:921988805442043925> The User: \`${user.username}\` is not registered as an Admin Role anymore`)
                    .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                    .setDescription(`Everyone with one of those Roles/Users:\n${cmdrole.join("\n")}\nis now able to use the ${thecmd} Admin Commands`.substr(0, 2048))
                    .setFooter(es.footertext, es.footericon)
                  });
        ...
        await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
          ...
          .then(collected => {
            ...
            if (role) {
              var adminroles = client.settings.get(message.guild.id, "adminroles")
              if (adminroles.includes(role.id)) return message.reply({embed: new Discord.MessageEmbed()
                .setTitle(`<a:no:921989165242003476> ERROR | The role: \`${role.name}\` is already registered as an Admin Role`)
                .setColor(es.wrongcolor)
                .setFooter(es.footertext, es.footericon)
              });
              try {
        ...
        await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
          ...
          .then(collected => {
            ...
            if (role) {
              var adminroles = client.settings.get(message.guild.id, "adminroles")
              if (!adminroles.includes(role.id)) return message.reply({embed: new Discord.MessageEmbed()
                .setTitle(`<a:no:921989165242003476> ERROR | The role: \`${role.name}\` is not registered as an Admin Role yet`)
                .setColor(es.wrongcolor)
                .setFooter(es.footertext, es.footericon)
              });
              try {
