    ...
    try {
      ...
      try {
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle("<a:no:921989165242003476> Missing Permission to add Reactions")
      ...
      if (timeouterror)
        return message.reply(new Discord.MessageEmbed()
          .setTitle("<a:no:921989165242003476> Your Time ran out")
          .setColor(es.wrongcolor)
      ...
      await tempmsg.channel.awaitMessages(m=>m.author.id == message.author.id, {
        ...
        .then(async collected => {
          ...
          if(channel){
            ...
            return message.reply(new Discord.MessageEmbed()
              .setTitle(`<a:yes2:921988805442043925> The Channel: \`${channel.name}\` is now registered as the Ai-Chat`)
              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
      ...
      if (timeouterror)
        return message.reply(new Discord.MessageEmbed()
          ...
          return message.reply(new Discord.MessageEmbed()
            .setTitle(`<a:yes2:921988805442043925> Disabled the Ai-Chat`)
            .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle("<a:no:921989165242003476> PLEASE CONTACT `RôÑ#7322 `")
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
        );
      }
