...
*React with the Right Emoji according to the Right action*`).setFooter(es.footertext, es.footericon)
      ...
      if (temptype == "set") {
        ...
        await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
          ...
          .then(async collected => {
            ...
            if(msg && msg.mentions.channels.filter(ch=>ch.guild.id==msg.guild.id).first()){
              ...
              return message.reply(new Discord.MessageEmbed()
                .setTitle(`<a:yes2:921988805442043925> I will now send all tiktok Notifications in \`${msg.mentions.channels.filter(ch=>ch.guild.id==msg.guild.id).first().name}\``)
        ...
        if(client.social_log.get(message.guild.id, "tiktok.channels").length >= 3) 
          return message.reply(new Discord.MessageEmbed()
            .setTitle("<a:no:921989165242003476> ERROR | You've reached the maximum amount of tiktok Channels")
            .setColor(es.wrongcolor)
...
https://www.tiktok.com/@milratodev`)
          ...
          .then(async collected => {
            ...
            if(msg && msg.content ){
              ...
              if(client.social_log.get(message.guild.id, "tiktok.channels").includes(Channel))
                return message.reply(new Discord.MessageEmbed()
                  .setTitle("<a:no:921989165242003476> ERROR | The tiktok Channel is already setup!")
                  .setColor(es.wrongcolor)
                  .setFooter(es.footertext, es.footericon)
                );
              ...
              return message.reply(new Discord.MessageEmbed()
                .setTitle(`<a:yes2:921988805442043925> added the Channel ${Channel}`)
        ...
        if(client.social_log.get(message.guild.id, "tiktok.channels").length <= 0) 
          return message.reply(new Discord.MessageEmbed()
            .setTitle("<a:no:921989165242003476> ERROR | You havent setup any tiktok Channels yet!")
            .setColor(es.wrongcolor)
