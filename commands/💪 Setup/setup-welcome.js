    ...
    try {
      ...
      if (temptype == "channel") {
          ...
          .then(async collected => {
                ...
                .then(collected => {
                  ...
                  if (channel) {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> The new Welcome Cannel is: \`${channel.name}\``)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle("<a:no:921989165242003476> ERROR | Something went wrong, please contact: `RôÑ#7322 `")
                        .setColor(es.wrongcolor)
            ...
            //Disable - CHANNEL
              ...
              try {
                ...
                return reaction.message.channel.send(new Discord.MessageEmbed()
                  .setTitle(`<a:yes2:921988805442043925> Disabled the Welcome **Message**`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                ...
                .then(async collected => {
                  ...
                  if (reaction.emoji.name === "1️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> I will now send no Image with the Welcome Message`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  ...
                  if (reaction.emoji.name === "2️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> I will now send an Image with the Welcome Message`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                      ...
                      .then(collected => {
                        ...
                        if (collected.first().attachments.size > 0) {
                          if (collected.first().attachments.every(attachIsImage)) {
                            ...
                            return reaction.message.channel.send(new Discord.MessageEmbed()
                              .setTitle(`<a:yes2:921988805442043925> I will now use your Custom Background image`)
                              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                              .setDescription(`I will be using ${client.settings.get(message.guild.id, "welcome.custom") === "no" ? "an Auto generated Image with User Data": "Your defined, custom Image" }\n\nIf Someone joins this Server, a message **with an image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                              .setFooter(es.footertext, es.footericon)
                            );
                            ...
                            return reaction.message.channel.send(new Discord.MessageEmbed()
                              .setTitle("<a:no:921989165242003476> Error | Your Attachment is not a valid Image!")
                              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                              .setFooter(es.footertext, es.footericon)
                            );
                          }
                          ...
                          if (isValidURL(collected.first().content)) {
                            ...
                            return reaction.message.channel.send(new Discord.MessageEmbed()
                              .setTitle("<a:no:921989165242003476> Error | You didn't entered a valid Link!")
                  ...
                  if (reaction.emoji.name === "4️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> I will now send an Auto generated Image with an transparent Background, including your Guild Avatar`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                      ...
                      .then(collected => {
                        ...
                        if (collected.first().attachments.size > 0) {
                          if (collected.first().attachments.every(attachIsImage)) {
                            ...
                            return reaction.message.channel.send(new Discord.MessageEmbed()
                              .setTitle(`<a:yes2:921988805442043925> I will now use your Custom image`)
                              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                              .setDescription(`I will be using ${client.settings.get(message.guild.id, "welcome.custom") === "no" ? "an Auto generated Image with User Data": "Your defined, custom Image" }\n\nIf Someone joins this Server, a message **with an image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                              .setFooter(es.footertext, es.footericon)
                            );
                  ...
                  if (reaction.emoji.name === "6️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> ${client.settings.get(message.guild.id, "welcome.frame") ? "Enabled the Frame for the Automated Welcome Image" : "Disabled the Frame for the Automated Welcome Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  ...
                  if (reaction.emoji.name === "7️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> ${client.settings.get(message.guild.id, "welcome.discriminator") ? "Enabled the Discrimantor (4 Numbers with #) for the Automated Welcome Image" : "Disabled the Discrimantor (4 Numbers with #) for the Automated Welcome Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "8️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> ${client.settings.get(message.guild.id, "welcome.membercount") ? "Enabled the MemberCount Text for the Automated Welcome Image" : "Disabled the MemberCount Text for the Automated Welcome Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "9️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> ${client.settings.get(message.guild.id, "welcome.servername") ? "Enabled Servername Text Frame for the Automated Welcome Image" : "Disabled the Servername Text for the Automated Welcome Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "🔟") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> ${client.settings.get(message.guild.id, "welcome.pb") ? "Enabled Profile Picture for the Automated Welcome Image" : "Disabled Profile Picture for the Automated Welcome Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                    ...
                    await tempmsg.awaitReactions(filter, {
                      ...
                      .then(async collected => {
                        ...
                        try {
                          ...
                          return message.reply(new Discord.MessageEmbed()
                            .setTitle(`<a:yes2:921988805442043925> CHANGED THE COLOR FOR THE FRAME`)
                            .setColor(color)
                            .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                            .setFooter(es.footertext, es.footericon)
                          );
              ...
              await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
                ...
                .then(collected => {
                  ...
                  try {
                    ...
                    return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<a:yes2:921988805442043925> The new Welcome Message is:`)
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
            ...
            //Enable/Disable Invite Information - CHANNEL
              ...
              try {
                ...
                return reaction.message.channel.send(new Discord.MessageEmbed()
                  .setTitle(`<a:yes2:921988805442043925> ${client.settings.get(message.guild.id, "welcome.invite") ? "Enabled Invite Information" : "Disabled INvite INformation"}`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          ...
          .then(async collected => {
            ...
            if (reaction.emoji.name === "1️⃣") {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:yes2:921988805442043925> I will now send Welcome-Messages to a new User in his DMS`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
            ...
            //Disable - CHANNEL
              ...
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a:yes2:921988805442043925> I will now send **NO** Welcome-Messages to a new User in his DMS`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
                ...
                .then(async collected => {
                  ...
                  if (reaction.emoji.name === "1️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> I will now send no Image with the Welcome Message (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setFooter(es.footertext, es.footericon)
                      );
                    } catch (e) {
                  ...
                  if (reaction.emoji.name === "2️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> I will now send an Image with the Welcome Message (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setFooter(es.footertext, es.footericon)
                      );
                    } catch (e) {
                      ...
                      .then(collected => {
                        ...
                        if (collected.first().attachments.size > 0) {
                          if (collected.first().attachments.every(attachIsImage)) {
                            ...
                            return reaction.message.channel.send(new Discord.MessageEmbed()
                              .setTitle(`<a:yes2:921988805442043925> I will now use your Custom Background image (dm)`)
                              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  ...
                  if (reaction.emoji.name === "4️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> I will now send an Auto generated Image with an transparent Background, including your Guild Avatar (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setFooter(es.footertext, es.footericon)
                      );
                    } catch (e) {
                      ...
                      .then(collected => {
                        ...
                        if (collected.first().attachments.size > 0) {
                          if (collected.first().attachments.every(attachIsImage)) {
                            ...
                            return reaction.message.channel.send(new Discord.MessageEmbed()
                              .setTitle(`<a:yes2:921988805442043925> I will now use your Custom image (DM)`)
                              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                              .setDescription(`I will be using ${client.settings.get(message.guild.id, "welcome.customdm") === "no" ? "an Auto generated Image with User Data": "Your defined, custom Image" }`.substr(0, 2048))
                              .setFooter(es.footertext, es.footericon)
                            );
                  ...
                  if (reaction.emoji.name === "6️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> ${client.settings.get(message.guild.id, "welcome.framedm") ? "Enabled the Frame for the Automated Welcome Image" : "Disabled the Frame for the Automated Welcome Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setFooter(es.footertext, es.footericon)
                      );
                    } catch (e) {
                  ...
                  if (reaction.emoji.name === "7️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> ${client.settings.get(message.guild.id, "welcome.discriminatordm") ? "Enabled the Discrimantor (4 Numbers with #) for the Automated Welcome Image" : "Disabled the Discrimantor (4 Numbers with #) for the Automated Welcome Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "8️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> ${client.settings.get(message.guild.id, "welcome.membercountdm") ? "Enabled the MemberCount Text for the Automated Welcome Image" : "Disabled the MemberCount Textthe Automated Welcome Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "9️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> ${client.settings.get(message.guild.id, "welcome.servernamedm") ? "Enabled Servername Text Frame for the Automated Welcome Image" : "Disabled the Servername Text for the Automated Welcome Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "🔟") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a:yes2:921988805442043925> ${client.settings.get(message.guild.id, "welcome.pbdm") ? "Enabled Profile Picture for the Automated Welcome Image" : "Disabled Profile Picture for the Automated Welcome Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                    ...
                    await tempmsg.awaitReactions(filter, {
                      ...
                      .then(async collected => {
                        ...
                        try {
                          ...
                          return message.reply(new Discord.MessageEmbed()
                            .setTitle(`<a:yes2:921988805442043925> CHANGED THE COLOR FOR THE FRAME (DM)`)
                            .setColor(color)
                            .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                            .setFooter(es.footertext, es.footericon)
                          );
              ...
              await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
                ...
                .then(collected => {
                  ...
                  try {
                    ...
                    return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<a:yes2:921988805442043925> The new Welcome Message is: (DM)`)
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
            ...
            //Enable/Disable Invite Information - CHANNEL
              ...
              try {
                ...
                return reaction.message.channel.send(new Discord.MessageEmbed()
                  .setTitle(`<a:yes2:921988805442043925> ${client.settings.get(message.guild.id, "welcome.invitedm") ? "Enabled Invite Information" : "Disabled INvite INformation"}`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
        ...
        *React with the Right Emoji according to the Right action*`)
                ...
                .then(collected => {
                  ...
                  if (role) {
                    ...
                    if (welcomeroles.includes(role.id)) return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<a:no:921989165242003476> ERROR | The role: \`${role.name}\` is already registered as an Welcome Role`)
                      .setColor(es.wrongcolor)
                      .setFooter(es.footertext, es.footericon)
                    );
                    client.settings.push(message.guild.id, role.id, "welcome.roles");
                    return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<a:yes2:921988805442043925> The role: \`${role.name}\` is now registered as an Welcome Role`)
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
              ...
              await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
                ...
                .then(collected => {
                  ...
                  if (role) {
                    var welcomeroles = client.settings.get(message.guild.id, "welcome.roles")
                    if (!welcomeroles.includes(role.id)) return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<a:no:921989165242003476> ERROR | The role: \`${role.name}\` is not registered as an Welcome Role yet`)
                      .setColor(es.wrongcolor)
                      .setFooter(es.footertext, es.footericon)
                    );
                    client.settings.remove(message.guild.id, role.id, "welcome.roles");
                    return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<a:yes2:921988805442043925> Remove the role: \`${role.name}\` from the Welcome Roles`)
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                      .setDescription(`Everyone who joins will get those Roles now:\n<@&${client.settings.get(message.guild.id, "welcome.roles").join(">\n<@&")}>`.substr(0, 2048))
                      .setFooter(es.footertext, es.footericon)
                    );
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(`<a:yes2:921988805442043925> ${client.settings.get(message.guild.id, "welcome.captcha") ? "Enabled the Captcha System" : "Disabled the Cpatcha System"}`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
