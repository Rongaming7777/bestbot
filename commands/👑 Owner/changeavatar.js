    ...
    try {
      ...
      if (message.attachments.size > 0) {
        if (message.attachments.every(attachIsImage)) {
          ...
          .then(user => {
            return message.channel.send(new MessageEmbed()
            .setTitle(`<a:yes2:921988805442043925> Successfully, changed the Bot avatar!`)
            .setColor(es.color)
            .setFooter(es.footertext, es.footericon)
          );
          })
          ...
          return message.channel.send(new MessageEmbed()
            .setTitle(`<a:no:921989165242003476> ERROR | Could not use your Image as an Avatar, make sure it is a \`png\` / \`jpg\``)
            .setColor(es.wrongcolor)
            .setFooter(es.footertext, es.footericon)
          );
        }
        ...
        return message.channel.send(new MessageEmbed()
            .setTitle(`<a:no:921989165242003476> ERROR | Could not use your Image as an Avatar, make sure it is a \`png\` / \`jpg\` / \`webp\``)
