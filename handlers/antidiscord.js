                    ...
                    if (!isOurInvite) {
                        ...
                        if (Number(countermap.get(message.author.id)) > 5) {
                            ...
                            message.channel.send(new MessageEmbed()
                                ...
                                .setTitle(`<a:yes2:921988805442043925> \`${member.user.tag}\` got **MUTED** for \`10 Minutes\``)
                            ...
                            return message.channel.send(new MessageEmbed()
                                ...
                                .setFooter(es.footertext, es.footericon)
                                .setTitle(`<a:no:921989165242003476> You are not allowed to send Discord related Links in this Channel`)
                            ).then(msg => msg.delete({
                                timeout: 3000
